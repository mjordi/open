...
Live demo: **[Deploy to Vercel for live preview →](DEPLOYMENT.md)**

> The frontend is deployed using Vercel with automatic PR previews. See [DEPLOYMENT.md](DEPLOYMENT.md) for setup instructions.
