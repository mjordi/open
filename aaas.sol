 pragma solidity ^0.4.24;
    ...
    function getAsset(string assetKey) public view returns(address assetOwner, string assetDescription, bool initialized, uint authorizationCount) {
    ...
    function getAssetAuthorization(string assetKey, address authorizationKey) public view returns(string authorizationRole) {
        return(
            assetStructs[assetKey].authorizationStructs[authorizationKey].role);
    }
    ...
    function getAssetAtIndex(uint row) public view returns(string assetkey) {
        return assetList[row];
    }

    function getAssetAuthorizationCount(string assetKey) public view returns(uint authorizationCount) {
        return(assetStructs[assetKey].authorizationList.length);
    }

    function getAssetAuthorizationAtIndex(string assetKey, uint authorizationRow) public view returns(address authorizationKey) {
