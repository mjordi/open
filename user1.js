$(window).on('load', function () {
    ...
    $('#form_assign').on('submit', function (e) {
        ...
        smartContractInstance.RoleChange().watch(function (error, result) {
            if (!error) {
                console.log("The role '" + result.args._role + "' was changed for " + result.args._client);
            }
        });
    });
    ...
    $('#form_isAssigned').on('submit', function (e) {
        ...
        smartContractInstance.isAssignedRole($('#address_isAssigned').val(), $('#role_isAssigned').val(), function (error, res) {
            console.log(error);
            console.log(res);
